...
-- -----------------------------------------------------
-- Table `ProyectoBD`.`Estado_Evento`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProyectoBD`.`Estado_Evento` ;

CREATE TABLE IF NOT EXISTS `ProyectoBD`.`Estado_Evento` (
...
CREATE TABLE IF NOT EXISTS `ProyectoBD`.`Eventos` (
  ...
  `Estado_Evento_idEstado_Evento` INT NOT NULL,
  ...
  INDEX `fk_Eventos_Estado_Evento1_idx` (`Estado_Evento_idEstado_Evento` ASC),
  ...
  CONSTRAINT `fk_Eventos_Tipo_Evento1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Eventos_Estado_Evento1`
    FOREIGN KEY (`Estado_Evento_idEstado_Evento`)
    REFERENCES `ProyectoBD`.`Estado_Evento` (`idEstado_Evento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ProyectoBD`.`Estado_Reservacion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProyectoBD`.`Estado_Reservacion` ;
...
CREATE TABLE IF NOT EXISTS `ProyectoBD`.`Reservacion` (
  ...
  `Estado_Reservacion_idEstado_Reservacion` INT NOT NULL,
  PRIMARY KEY (`idReservacion`),
  INDEX `fk_Reservas_Eventos1_idx` (`Eventos_idEventos` ASC),
  INDEX `fk_Reservacion_Cliente1_idx` (`Cliente_idCliente` ASC),
  INDEX `fk_Reservacion_Estado_Reservacion1_idx` (`Estado_Reservacion_idEstado_Reservacion` ASC),
  ...
  CONSTRAINT `fk_Reservacion_Cliente1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Reservacion_Estado_Reservacion1`
    FOREIGN KEY (`Estado_Reservacion_idEstado_Reservacion`)
    REFERENCES `ProyectoBD`.`Estado_Reservacion` (`idEstado_Reservacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
